...
const _IF = "InventoryFormat";
const _IFn = "InventoryFrequency";
...
export var Checksum = __struct(_Ch, 0, [_CCRC, _CCRCC, _CCRCNVME, _CSHA, _CSHAh, _CT], [0, 0, 0, 0, 0, 0]);
...
export var DefaultRetention = __struct(_DRe, 0, [_Mo, _D, _Y], [0, 1, 1]);
...
export var LifecycleExpiration = __struct(_LEi, 0, [_Da, _D, _EODM], [5, 1, 2]);
...
export var ObjectPart = __struct(_OPb, 0, [_PN, _S, _CCRC, _CCRCC, _CCRCNVME, _CSHA, _CSHAh], [1, 1, 0, 0, 0, 0, 0]);
...
export var Tiering = __struct(_Tier, 0, [_D, _AT], [1, 0]);
...
export var Transition = __struct(_Tra, 0, [_Da, _D, _SC], [5, 1, 0]);
