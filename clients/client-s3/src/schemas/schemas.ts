...
export var Bucket = struct(n0, _B, 0, [_N, _CD, _BR], [0, 4, 0]);
...
export var CreateBucketConfiguration = struct(n0, _CBC, 0, [_LC, _L, _B], [0, () => LocationInfo, () => BucketInfo]);
...
export var MetricsConfiguration = struct(n0, _MC, 0, [_I, _F], [0, [() => MetricsFilter, 0]]);
...
export var S3TablesDestinationResult = struct(n0, _STDR, 0, [_TBA, _TN, _TA, _TNa], [0, 0, 0, 0]);
