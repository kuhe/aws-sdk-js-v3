...
// se_EntityAttributesMap omitted.

// se_EntityKeyAttributesMap omitted.

/**
 * serializeRpcv2cborEntityMetricData
 */
...
const se_PutMetricDataInput = (input: PutMetricDataInput, context: __SerdeContext): any => {
  return take(input, {
    EntityMetricData: (_) => se_EntityMetricDataList(_, context),
    MetricData: (_) => se_MetricData(_, context),
    Namespace: [],
