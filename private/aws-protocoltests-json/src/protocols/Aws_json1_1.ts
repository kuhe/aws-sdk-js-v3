...
const serializeAws_json1_1KitchenSink = (input: KitchenSink, context: __SerdeContext): any => {
  return {
    ...
    ...(input.Iso8601Timestamp != null && { Iso8601Timestamp: __timestampInputParam(input.Iso8601Timestamp, "D") }),
    ...
    ...(input.UnixTimestamp != null && { UnixTimestamp: __timestampInputParam(input.UnixTimestamp, "E") }),
  };
};
